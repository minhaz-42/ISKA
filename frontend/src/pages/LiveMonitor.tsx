  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-[22px] font-semibold text-[var(--pkf-text-strong)]">Live monitor</h1>
        ...
        <div className="flex items-center gap-2">
          <span
            className={`h-2 w-2 rounded-full ${enabled ? 'bg-[var(--pkf-success)]' : 'bg-[var(--pkf-text-subtle)]'}`}
          />
          <span className="text-[13px] text-[var(--pkf-text-muted)]">
      ...
      {/* Main Toggle */}
      <div className="rounded-2xl bg-[var(--pkf-card)] p-6 ring-1 ring-[var(--pkf-border)]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--pkf-primary-subtle)]">
              <Eye className="h-5 w-5 text-[var(--pkf-primary)]" />
            </div>
            <div>
              <h2 className="text-[15px] font-medium text-[var(--pkf-text-strong)]">
                Enable live monitor
              </h2>
          ...
          <button
            ...
            className={`pkf-focus relative h-8 w-14 rounded-full transition-colors ${
              enabled
                ? 'bg-[var(--pkf-primary)]'
                : 'bg-[var(--pkf-overlay)] ring-1 ring-[var(--pkf-border)]'
            }`}
          >
            <span
      ...
      {/* Signal Types */}
      <section>
        <h2 className="mb-4 text-[16px] font-medium text-[var(--pkf-text-strong)]">Signal types</h2>
      ...
      <section>
        ...
        <div className="rounded-2xl bg-[var(--pkf-surface)] p-6 ring-1 ring-[var(--pkf-border)]">
          <p className="text-[14px] text-[var(--pkf-text)] leading-relaxed mb-4">
