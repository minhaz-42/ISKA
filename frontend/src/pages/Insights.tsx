  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-[22px] font-semibold text-[var(--pkf-text-strong)]">Insights</h1>
        ...
        <div className="flex items-center gap-2">
          <Filter className="h-4 w-4 text-[var(--pkf-text-muted)]" />
          <select
            value={filter}
            onChange={(e) => setFilter(e.target.value as typeof filter)}
            className="pkf-focus rounded-lg bg-[var(--pkf-surface)] px-3 py-2 text-[13px] text-[var(--pkf-text)] ring-1 ring-[var(--pkf-border)]"
          >
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl bg-[var(--pkf-card)] p-5 ring-1 ring-[var(--pkf-border)]">
          ...
          <div className="mt-2 text-[24px] font-semibold text-[var(--pkf-text-strong)]">8</div>
          <div className="mt-1 text-[12px] text-[var(--pkf-text-muted)]">new insights</div>
        </div>
        ...
        <div className="rounded-2xl bg-[var(--pkf-card)] p-5 ring-1 ring-[var(--pkf-border)]">
          ...
          <div className="mt-2 text-[24px] font-semibold text-[var(--pkf-text-strong)]">23</div>
          <div className="mt-1 text-[12px] text-[var(--pkf-text-muted)]">total insights</div>
        </div>
        ...
        <div className="rounded-2xl bg-[var(--pkf-card)] p-5 ring-1 ring-[var(--pkf-border)]">
          ...
          <div className="mt-2 text-[16px] font-semibold text-[var(--pkf-text-strong)]">
            Persuasion patterns
          </div>
          <div className="mt-1 text-[12px] text-[var(--pkf-text-muted)]">40% of insights</div>
        </div>
      </div>
